  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-500 via-slate-200 to-slate-100 py-12 px-4">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Vision Section */}
        <div className="bg-sky-100 rounded-3xl p-8 md:p-12 shadow-sm border border-gray-200">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative">
              <div className="text-6xl md:text-8xl font-bold text-white opacity-10 text-center select-none">
                VISION
              </div>
        ...
        <div className="bg-sky-100 rounded-3xl p-8 md:p-12 shadow-sm border border-gray-200">
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                {
                  icon: <Building2 className="w-12 h-12 text-sky-700 mx-auto mb-3" />,
                  title: "Heritage Structures",
                  desc: "Conservation and restoration of monuments",
                },
                {
                  icon: <Palette className="w-12 h-12 text-sky-700 mx-auto mb-3" />,
                  title: "Traditional Arts",
                  desc: "Preserving art forms and crafts",
                },
                {
                  icon: <Users className="w-12 h-12 text-sky-700 mx-auto mb-3" />,
                  title: "Community Engagement",
                  desc: "Building heritage awareness",
                },
                {
                  icon: <Globe className="w-12 h-12 text-sky-700 mx-auto mb-3" />,
...
export default function GoverningBody() {
  ...
  return (
    <>
      <AboutUs />
      <div className="bg-gradient-to-b from-slate-400 via-slate-300 to-slate-200 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {governingBodyMembers.map((member, index) => (
              <div
                key={index}
                className="bg-slate-100 shadow-md border border-gray-300 rounded-xl p-6"
              >
